...
class Privacy extends React.Component {
    columns = [
        ...
        },
        {
            ...
            render: (options, row) => {
                return (
                    <div>
                        {options.edit && isAllowed("/privacy/edit") && (
                            <Button type="link">
                                <Link
                                    to={{
                                        pathname: "/privacy/edit",
    ...
    fetch = (params = {}) => {
        ...
        reqwest({
            url: "/api/auth/privacy/datatable",
            method: "post",
            type: "json",
            headers: {
        ...
        return (
            <PageLayout>
                <Breadcrumb style={{ margin: "16px 0" }}>
                    <Breadcrumb.Item>{t("privacy")}</Breadcrumb.Item>
                </Breadcrumb>
                <PageHeader
                    className="site-page-header"
                    title={t("privacy")}
                    subTitle={t("edit_privacy")}
                >
                    <Content
