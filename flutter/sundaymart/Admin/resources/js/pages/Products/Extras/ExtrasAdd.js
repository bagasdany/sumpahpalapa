...
class ExtrasAdd extends React.Component {
    ...
    constructor(props) {
        ...
        this.onChangeProductExtraName =
            this.onChangeProductExtraName.bind(this);
        this.onChangeExtraDescription =
            this.onChangeExtraDescription.bind(this);
    ...
    getInfoById = async (id) => {
        ...
        if (data.data.success) {
            let extras = data.data.data;
            let extras_language = data.data.data["languages"];
            ...
            for (let i = 0; i < extras_language.length; i++) {
                var lang = extras_language[i].language.short_name;
            ...
            fileListArray.push({
                ...
                status: "done",
                url: IMAGE_PATH + extras.image_url,
            });
            ...
            this.setState({
                ...
                extras_group_type: extras.extras_group.type,
            });
    ...
    onFinish = async (values) => {
        ...
        let data = await extrasSave(
            this.state.extras_group_id,
            this.state.extra_names,
            this.state.extra_descriptions,
            img_url,
            values.price_extras,
            values.quantity,
            this.state.background_color,
            this.state.active_extra,
            this.state.id
        );
    ...
    render() {
        ...
        return (
            <PageHeader
                ...
                title={
                    this.state.edit
                        ? t("product_extras_edit")
                        : t("product_extras_add")
                }
            >
                <Form
                    ref={this.formRef}
                    ...
                    >
                        ...
                        <div className="row">
                            <div className="col-md-4 col-sm-12">
                                <Form.Item
                                    name="extras_group"
                                    label={t("extras_group")}
                                    tooltip={t("select_extras_group")}
                                >
                                    <Select
                                        placeholder={t("select_extras_group")}
                            ...
                            <div className="col-md-4 col-sm-12">
                                <Form.Item
                                    label={t("product_extras_name")}
                                    name="extra_name"
                                    rules={[
                                        {
                                            required: true,
                                            message: t(
                                                "missing_product_extras_name"
                                            ),
                                        },
                                    ]}
                                    tooltip={t("enter_product_extras_name")}
                                >
                                    <Input
                                        placeholder={t("product_extras_name")}
                                    ...
                                    rules={[
                                        {
                                            required: true,
                                            message: t(
                                                "missing_extras_description"
                                            ),
                                        },
                                    ]}
                                    tooltip={t("enter_extras_description")}
                                >
                                    <TextArea
                                        showCount
                                        maxLength={100}
                            ...
                            {this.state.extras_group_type == 1 && (
                                <div className="col-md-3 col-sm-6">
                                    <Form.Item
                                        label={t("extras_image")}
                                        tooltip={t("upload_extras_image")}
                                    >
                                        <Form.Item
                                            name="dragger"
                            ...
                            {this.state.extras_group_type == 2 && (
                                <div className="col-md-3 col-sm-6">
                                    <Form.Item
                                        ...
                                        tooltip={t("select_background_color")}
                                    >
                                        <SketchPicker
                            ...
                            <div className="col-md-3 col-sm-6">
                                <Form.Item
                                    ...
                                    rules={[
                                        {
                                            required: true,
                                            message: t("missing_quantity"),
                                        },
                                    ]}
                                    tooltip={t("enter_quantity")}
                                >
                            ...
                            <div className="col-md-3 col-sm-6">
                                ...
                                >
                                    <Checkbox
                                        checked={this.state.active_extra}
...
export default withTranslation()(ExtrasAdd);
