    ...
    columns = [
        {
            ...
            render: (discount_type) => {
                if (discount_type == 2) return "Fixed price";
        ...
        },
        {
            ...
            render: (is_count_down) => {
                if (is_count_down == 1) return <Tag color="success">Yes</Tag>;
        ...
        return (
            <PageLayout>
                <Breadcrumb style={{ margin: "16px 0" }}>
                    <Breadcrumb.Item>{t("discounts")}</Breadcrumb.Item>
                </Breadcrumb>
                <PageHeader
                    className="site-page-header"
                    title={t("discounts")}
                    subTitle={t("create_remove_and_edit_discounts")}
                    extra={
                        isAllowed("/discounts/add") && [
                            <Link
                                to="/discounts/add"
                                key="add"
