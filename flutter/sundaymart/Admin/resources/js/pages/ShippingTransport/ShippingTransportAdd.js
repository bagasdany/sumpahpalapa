...
import shippingTransportSave from "../../requests/ShippingTransport/ShippingTransportSave";
import shippingTransportGet from "../../requests/ShippingTransport/ShippingTransportGet";
...
class ShippingTransport extends React.Component {
    ...
    getInfoById = async (id) => {
        let data = await shippingTransportGet(id);
    ...
    onFinish = async (values) => {
        ...
        let data = await shippingTransportSave(
            this.state.names,
        ...
        return (
            <PageLayout>
                <Breadcrumb style={{ margin: "16px 0" }}>
                    <Breadcrumb.Item>
                        <Link to="/shipping-transports" className="nav-text">
                ...
                <PageHeader
                    ...
                    title={
                        this.state.edit
                            ? t("shipping_transports_edit")
                            : t("shipping_transports_add")
                    }
                >
