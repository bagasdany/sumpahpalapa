...
class UnitAdd extends React.Component {
    ...
    getInfoById = async (id) => {
        ...
        if (data.data.success) {
            let units = data.data.data;
            let units_language = data.data.data["languages"];

            var namesArray = this.state.names;
            for (let i = 0; i < units_language.length; i++) {
                var lang = units_language[i].language.short_name;
        ...
        return (
            <PageLayout>
                ...
                <PageHeader
                    ...
                    title={this.state.edit ? t("unit_edit") : t("unit_add")}
                >
...
export default withTranslation()(UnitAdd);
