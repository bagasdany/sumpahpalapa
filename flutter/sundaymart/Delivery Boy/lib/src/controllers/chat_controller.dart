...
import 'package:deliveryboy/src/models/dialog.dart';
import 'package:deliveryboy/src/models/message.dart';
import 'package:deliveryboy/src/models/user.dart';
import 'package:deliveryboy/src/requests/chat_dialog_request.dart';
import 'package:deliveryboy/src/requests/chat_message_request.dart';
import 'package:deliveryboy/src/requests/shop_user_request.dart';
...
class ChatController extends GetxController {
  ...
  Future<void> getShopUser() async {
    ...
    if (authController.user.value != null &&
      ...
      shopId = authController.user.value!.id!;
    }
